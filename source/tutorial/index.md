...
### 1.2 方法
打开ECUSTMC皮肤站网址：https://mcskin.ecustvr.top/，校内同学可以使用https://mcskin.ecustcic.eu.org/，非华东理工大学的同学可以在https://skin.mualliance.ltd/注册账号

#### 1.2.1 统一身份认证注册（有统一身份认证的同学）
进入页面，点击登录/现在注册，点击“注册新账号”。在新的页面上点击“统一身份认证注册（免邀请码）”，你就能使用统一身份认证账号注册皮肤站账号了。注册完成后，回到登陆界面，在用户名处输入**邮箱**登录（学号@mail.ecust.edu.cn）。首次登录完成后，你需要输入你想要使用的游戏用户名，创建你的游戏角色。如果没有提示你输入游戏用户名，请手动创建一个：

![创建角色](https://mc.sjtu.cn/wp-content/uploads/2023/08/image.png)

使用统一身份认证注册后，账号没有密码，如需添加密码，请在登录界面点击忘记密码/联系管理员。
